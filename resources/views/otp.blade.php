            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                 ...
                 <div class="alert alert-danger"> {{ $error }}</div>
                    ...
                    <form action="{{url('verify_bdapps_otp')}}" id="login-form" class="white-popup-block" method="post">
                        {{csrf_field()}}
                        <div class="col-md-4 login-social" style="padding-top:5%">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Otp*" type="text" name="otp">
                                       
                      
                                        <input type="hidden" value="{{$reference_no}}" name="reference_no">
